...
namespace LinhShop.Helpers
{
    ...
    {
        // Creating valid culture
        private static readonly List<string> _validCultures =
            new List<string>
            {
        ...
        //Includes only cultures you are implementing
        private static readonly List<string> _cultures = new List<string>
        {
            "en-US",  // first culture is the DEFAULT
            "vi-VN", // Vietnam culture
        ...
        public static string GetNeutralCulture(string name)
        {
            ...
            return name.Split('-')[0]; // Read first part only. Eg "En", "es"
        }
    }
}